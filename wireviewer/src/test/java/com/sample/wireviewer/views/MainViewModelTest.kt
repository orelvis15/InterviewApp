...
internal class MainViewModelTest {
    ...
    @Test
    fun `Test request to wire api then return success`(){
        ...
        runTest {
            ...
            Mockito.`when`(repository.getWireCharacterList()).thenReturn(responseMock)
    ...
    @Test
    fun `Test request to wire api then return error`(){
